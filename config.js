System.config({
  ...
  map: {
    "azure-storage": "npm:azure-storage@0.6.0",
    ...
    "npm:azure-storage@0.6.0": {
      ...
      "url": "github:jspm/nodelibs-url@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0",
      "validator": "npm:validator@3.22.2",
    ...
    "npm:koa-bodyparser@2.0.1": {
      "co-body": "npm:co-body@3.1.0",
      "copy-to": "npm:copy-to@2.0.1"
    },
    "npm:koa-is-json@1.0.0": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0"
    },
    "npm:koa-logger@1.3.0": {
      "bytes": "npm:bytes@1.0.0",
      "chalk": "npm:chalk@1.1.1",
      "humanize-number": "npm:humanize-number@0.0.2",
      "passthrough-counter": "npm:passthrough-counter@1.0.0",
      "process": "github:jspm/nodelibs-process@0.1.1"
    },
